...
## Project Structure
    ...
    ├── solitary_morning_29716  # Django project configurations
...
1. Clone this repo and `cd solitary_morning_29716`
...
2. Clone this repo and `cd solitary_morning_29716`
